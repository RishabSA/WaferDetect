  ...
  return (
    <div className="rounded-xl border border-white/10 bg-white/5 p-4 backdrop-blur transition-colors hover:border-white/20">
      <div className="flex items-center justify-between gap-3">
        ...
        <span className="text-sm text-neutral-400">conf {percent(detection.confidence)}</span>
      </div>
      ...
      <p className="mt-2 text-sm text-neutral-200">{detection.diagnosis.mechanism}</p>
